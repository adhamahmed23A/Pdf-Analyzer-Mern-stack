  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-wrap  gap-1">
          ...
          <CommandPrimitive.Input
            ...
            className={cn(
              "placeholder:text-foreground  flex-1 px-3 outline-hidden disabled:cursor-not-allowed",
              {
          ...
          <button
            ...
            className={cn(
              "text-foreground hover:text-foreground focus-visible:border-ring focus-visible:ring-ring/50 absolute top-0 right-0 flex size-9 items-center justify-center rounded-md border border-transparent transition-[color,box-shadow] outline-none focus-visible:ring-[3px]",
              (hideClearAllButton ||
                disabled ||
                selected.length < 1 ||
      ...
      <div className="relative">
        <div
          className={cn(
            "border-input absolute top-2 z-10 w-fit overflow-hidden rounded-md border",
